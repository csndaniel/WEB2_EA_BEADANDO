    ...
    <div class="space-y-4">
        <div class="flex justify-between items-center">
            <p class="text-sm text-gray-300">
                Összesen <?php echo e($pilotas->count()); ?> pilóta az adatbázisban.
            </p>
            <a href="<?php echo e(route('pilotas.create')); ?>"
        ...
        <div class="bg-slate-900/80 border border-slate-700 rounded-xl shadow-lg overflow-x-auto">
            <table class="min-w-full divide-y divide-slate-700 text-sm">
                ...
                <tbody class="divide-y divide-slate-800">
                    <?php $__currentLoopData = $pilotas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-slate-800/70 transition">
                            <td class="px-4 py-2"><?php echo e($p->nev); ?></td>
                            <td class="px-4 py-2"><?php echo e($p->nemzet); ?></td>
                            <td class="px-4 py-2"><?php echo e($p->szulido); ?></td>
                            <td class="px-4 py-2 space-x-2">
                                <a href="<?php echo e(route('pilotas.edit', $p->id)); ?>"
                                   class="text-sky-400 hover:underline text-sm">Szerkesztés</a>

                                <form action="<?php echo e(route('pilotas.destroy', $p->id)); ?>"
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\web2projekt\resources\views/pilotas/index.blade.php ENDPATH**/ ?>